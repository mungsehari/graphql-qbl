...
import com.hari.book.Book;
import com.hari.book.BookRepository;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(
                new Book("Java Puzzlers: Traps, Pitfalls, and Corner Cases", "Joshua Bloch and Neal Gafter", 2005));
        ...
        repository.save(new Book("Spring Batch in Action",
                "Arnaud Cogoluegnes, Thierry Templier, Gary Gregory, and Olivier Bazoud", 2011));
        repository.save(new Book("Spring Integration in Action",
                "Mark Fisher, Jonas Partner, Marius Bogoevici, and Iwein Fuld", 2012));
        repository.save(new Book("Spring Data",
                "Mark Pollack, Oliver Gierke, Thomas Risberg, Jon Brisbin, and Michael Hunger", 2012));
        repository.save(
                new Book("Spring Recipes: A Problem-Solution Approach", "Gary Mak, Josh Long, and Daniel Rubio", 2010));
